...
class Trainer(object):
    ...
    def train(self, n_train_steps, p_explore=0, online=False):
        ...
        for step in range(n_train_steps):
            ...
            if self.sample_freq and self.step % self.sample_freq == 0:
                ...
                self.render_samples(n_samples=self.n_samples,p_explore=p_explore)
    ...
    def render_samples(self, p_explore, batch_size=2, n_samples=2):
        ...
        for i in range(batch_size):
            ...
            samples = self.ema_model.conditional_sample(conditions, guide=self.guide, verbose=True, p_explore=p_explore, **self.sample_kwargs)
